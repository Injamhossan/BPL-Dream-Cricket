  ...
  return (
    <>
      ...
      <div className="flex justify-between mx-auto max-w-[1600px] mt-[100px] items-center">
        <h1 className="text-black text-[28px] font-bold">Available Players</h1>
        <div className="flex border-2 border-[#1313131a] rounded-[10px] shadow-sm overflow-hidden">
          <button
            onClick={() => setToggole(true)}
            className={`text-black ${toggle===true?"bg-[#E7FE29]":""} font-bold px-6 py-2 border-r-2 border-[#1313131a] focus:outline-none`}
          >
            Available
          </button>
          <button
            onClick={() => setToggole(false)}
            className={`text-black ${toggle===false?"bg-[#E7FE29]":""} font-bold px-6 py-2 border-r-2 border-[#1313131a] focus:outline-none`}
          >
